package com.wyj.algorithm.example.arrays;
...
public class RotateImage {
    ...
    //TODO 方法二:分治思想,分为四个子矩阵分别考虑,只是使用一次循环,使用1/4矩阵数组的元素,但是时间复杂度还是O(n^2)
    ...
    public static void main(String[] args) {
        ...
        rotateImage.rotate03(image01);
        rotateImage.printImage(image01);

        rotateImage.rotate03(image02);
        rotateImage.printImage(image02);
    }
